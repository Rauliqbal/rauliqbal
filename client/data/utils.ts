...
export const SERVICES = [
  {
    ...
    description:
      "Create your amazing idea in websites, full interaction with responsive views.",
    icon: "developer.svg",
  },
  {
...
export const PROJECTS = [
  {
    title: "Ngajee - Al-Quran Digital",
    description: "📖 Al-Quran Digital dengan terjemah bahasa Indonesia.",
    img: "mymushaf.webp",
    url: "https://ngajee.web.id",
    type: "Web App",
  ...
  },
  {
    ...
    description:
      "Movieraa is a website for streaming movies and tv shows, but this is just a website view.",
    img: "movieraa.webp",
...

  {
    ...
    description:
      "Zullkit is a website that provides UI Kits and website designs.",
    img: "zullkit.webp",
...

  {
    ...
    description:
      "Furnilux is a website that provides home furnishings, to beautify your room.",
    img: "furnilux.webp",
